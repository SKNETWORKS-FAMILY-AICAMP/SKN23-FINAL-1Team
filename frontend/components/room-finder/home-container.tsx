  ...
  return (
    ...
    {toast && (
      <div
        ...
        className={`fixed top-5 right-5 z-[9998] flex items-center gap-2.5 rounded-xl border bg-white px-4 py-2.5 shadow-lg ${
          toast.type === "add" ? "border-[#0F6E56]" : "border-[#993C1D]"
        }`}
      >
        <style>{`
        ...
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
          <path
            ...
            fill={toast.type === "add" ? "#f43f5e" : "none"}
            stroke={toast.type === "add" ? "#f43f5e" : "#999"}
            strokeWidth="1.2"
          />
        </svg>
